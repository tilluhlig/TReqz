...
class reqif_attribute_value_string(TReqz.reqif_attribute_value):
    definition:TReqz.reqif_datatype_definition_string = None # localRef, required
    ...
    def decode(self, content:Element, id_dict:TReqz.reqif_id_dict={}):
        ...
        self.definition = TReqz.reqif_utils.get_local_ref_from_element_text(content, id_dict, "./{0}DEFINITION/{0}ATTRIBUTE-DEFINITION-STRING-REF".format(namespace))

    def encode(self):
        elem = super().encode()
        elem.tag = "ATTRIBUTE-VALUE-STRING"
