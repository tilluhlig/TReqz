...
class reqif_spec_relation_type(TReqz.reqif_identifiable):
    ...
    def decode(self, content:Element, id_dict:TReqz.reqif_id_dict={}):
        ...
        self.spec_attributes = TReqz.reqif_utils.generate_object_list_by_element_class(content, id_dict, "./{0}SPEC-ATTRIBUTES".format(namespace), typeList)

    def encode(self):
        elem = super().encode()
        elem.tag = "SPEC-RELATION-TYPE"
