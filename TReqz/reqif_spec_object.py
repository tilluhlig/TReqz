...
class reqif_spec_object(TReqz.reqif_identifiable):
    ...
    def decode(self, content:Element, id_dict:TReqz.reqif_id_dict={}):
        ...
        self.type = TReqz.reqif_utils.get_local_ref_from_element_text(content, id_dict, "./{0}TYPE/{0}SPEC-OBJECT-TYPE-REF".format(namespace)) 
    ...
    def encode(self):
        ...
        TReqz.reqif_utils.addRequiredSubElement(typeElement, "SPEC-OBJECT-TYPE-REF", self.type.identifier)
