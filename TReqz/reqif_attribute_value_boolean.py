...
class reqif_attribute_value_boolean(TReqz.reqif_attribute_value):
    ...
    def decode(self, content: Element, id_dict: TReqz.reqif_id_dict = {}):
        ...
        self.definition = TReqz.reqif_utils.get_local_ref_from_element_text(
            content, id_dict, "./{0}DEFINITION/{0}ATTRIBUTE-DEFINITION-BOOLEAN-REF".format(namespace))
    ...
    def encode(self):
        ...
        TReqz.xml_utils.addRequiredSubElement(
            definitionElement, "ATTRIBUTE-DEFINITION-BOOLEAN-REF", self.definition.identifier)
        return elem
