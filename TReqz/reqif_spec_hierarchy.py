...
class reqif_spec_hierarchy(TReqz.reqif_identifiable):
    ...
    def decode(self, content:Element, id_dict:TReqz.reqif_id_dict={}):
        ...
        self.editable_atts = TReqz.reqif_utils.generate_local_ref_list_from_elements_text(content, id_dict, "./EDITABLE-ATTS")    
    ...
    def encode(self):
        ...
        if len(self.editable_atts)>0:
            ...
            for attribute in self.editable_atts:
                TReqz.reqif_utils.addEncodedSubElement(attsElement, attribute)
