...
class reqif_specification(TReqz.reqif_identifiable):
    values:list=list() # reqif_attribute_value
    ...
    def decode(self, content:Element, id_dict:TReqz.reqif_id_dict={}):
        ...
        self.type = TReqz.reqif_utils.get_local_ref_from_element_text(content, id_dict, "./{0}TYPE/{0}SPECIFICATION-TYPE-REF".format(namespace))
    ...
    def encode(self):
        ...
        TReqz.reqif_utils.addRequiredSubElement(typeElement, "SPECIFICATION-TYPE-REF", self.type.identifier)
